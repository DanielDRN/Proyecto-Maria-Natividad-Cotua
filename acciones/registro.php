            ...
            if ($exists) {
                ...
                if (mysqli_stmt_execute($stmt_ins)) {
                    ...
                    if (isset($_POST['cedula_estudiante']) && is_array($_POST['cedula_estudiante']) && count($_POST['cedula_estudiante']) > 0) {
                        ...
                        $query_est = "INSERT INTO estudiantes (cedula, nombre, apellido, genero, grado_session, Fecha_nacimiento, id_representante) VALUES (?, ?, ?, ?, ?, ?, ?)";
                        ...
                        for ($i = 0; $i < count($cedulas_est); $i++) {
                            ...
                            mysqli_stmt_bind_param($stmt_est, "ssssssi", $ced_est, $nom_est, $ape_est, $sex_est, $gra_est, $fech_est, $id_representante);
