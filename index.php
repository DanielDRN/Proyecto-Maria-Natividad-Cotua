...
<body>
    ...
    <div class="content-wrapper">
        <div class="login-container">
            <h1 id="loginTitle">INICIA SESIÓN<br>EN TU CUENTA</h1>
            <form method="POST" action="">
                ...
                <button id="submitBtn" class="login" type="submit" name="login">INICIAR SESIÓN</button>
            </form>
            <div class="link-registro-container">
                <span class="link-registro" id="Registrarse">Registrarse</span>
            </div>
        </div>
        <div class="card-grid">
