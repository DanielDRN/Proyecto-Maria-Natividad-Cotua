...
<div id="modalAgregarEstudiante" class="modal-fondo">
    <div class="modal-contenido-estudiante"> 
        <div class="modal-header-estudiante">
            <h2 class="modal-titulo-estudiante"><i class="fas fa-user-plus"></i> Registrar Nuevo Estudiante</h2>
        ...
        <form id="formAgregarEstudiante" method="POST"> 
                <input type="hidden" 
                    ...
                    id="hidden_id_representante" 
                    value="<?php echo isset($id_representante) ? htmlspecialchars($id_representante) : 0; ?>">
            <div class="modal-body-estudiante">
                <div class="modal-grid">
                    
                    <div class="form-group">
                        <label class="form-label">Cédula</label>
                        <input type="text" class="form-control" name="cedula_estudiante" placeholder="Cédula del estudiante" onkeypress="return (event.charCode >= 48 && event.charCode <= 57)" required>
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label">Nombre</label>
                        <input type="text" class="form-control" name="nombre_estudiante" placeholder="Nombre del estudiante" onkeypress="return (event.charCode < 48 || event.charCode > 57)" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Apellido</label>
                        <input type="text" class="form-control" name="apellido_estudiante" placeholder="Apellido del estudiante" onkeypress="return (event.charCode < 48 || event.charCode > 57)" required>
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label">Fecha de Nacimiento</label>
                        <input type="date" class="form-control" name="fecha_estudiante" placeholder="Fecha de Nacimiento" required>
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label">Lugar de Nacimiento</label>
                        <input type="text" class="form-control" name="lugar_nacimiento" placeholder="Lugar de Nacimiento" onkeypress="return (event.charCode < 48 || event.charCode > 57)" required>
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label">Género</label>
                        <select class="form-control" name="sexo_estudiante" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="talla_camisa" placeholder="Ej: S, M, 10" required>
                    </div>
            ...
            <div class="modal-footer-estudiante">
                <button type="button" class="btn-cerrar-modal" id="btnCerrarModalFooter">Cerrar</button>
                <button type="submit" class="btn-guardar-estudiante" name="registrar_estudiante">
